        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <p>Investigacion(es) pendientes</p>
            </div>
...
document.write("Hoy es " + dayName[now.getDay()] + ", " + now.getDate() + " de "+ monName[now.getMonth()] +".")
            ...
            <a href="#" class="small-box-footer">Hora y Fecha <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
...
WHERE u.id_usuario = $id_profesor ORDER BY hs.fecha_inicio DESC"); 
$pagina->ejecutar();
