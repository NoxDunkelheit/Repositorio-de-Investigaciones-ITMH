        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="glyphicon glyphicon-book"></i> Investigaciones Aceptadas</li>
            </ul>
...
ON t.id_investigacion = i.id_investigacion WHERE u.id_usuario = $id_alumno AND i.status_investigacion LIKE 'ACEPTADA' ORDER BY i.fecha_investigacion"); 
$pagina->ejecutar();
echo "<table class='table table-hover table-bordered table-striped'>";
echo "<thead><tr class='success'><th>Folio</th><th>Titulo de la Investigacion</th><th><center>Fecha</center></th></tr></thead>";
