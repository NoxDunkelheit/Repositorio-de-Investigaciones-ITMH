...
//VARIABLES QUE GUARDAN UN HISTORIAL DE 5 SESIONES HECHAS ANTERIORMENTE (PARA CREAR MARCADORES EN EL MAPA)
            $hist_lat_1 = $objetoNegocios->obtenerLatSesionesAlumno(1);
            $hist_long_1 = $objetoNegocios->obtenerLongSesionesAlumno(1);
            $hist_fecha_1 = $objetoNegocios->obtenerFechaSesionesAlumno(1);
            $hist_lat_2 = $objetoNegocios->obtenerLatSesionesAlumno(2);
            $hist_long_2 = $objetoNegocios->obtenerLongSesionesAlumno(2);
            $hist_fecha_2 = $objetoNegocios->obtenerFechaSesionesAlumno(2);
...
<html><!--INICIO DEL DOCUMENTO HTML -->
          <head><!--ABRIENDO ETIQUETA HEAD -->
                <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/> <!--USO DE LA COLECCION DE CARACTERES UTF-8 -->
...
document.write("Hoy es " + dayName[now.getDay()] + ", " + now.getDate() + " de "+ monName[now.getMonth()] +".")
      ...
      <div id="subcontenedor" class="row">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div id="contenedor_1" class="nav-tabs-custom">
            <!-- Tabs within a box -->
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="glyphicon glyphicon-user"></i> Sesiones</li>
            </ul>
...
$pagina->agregarConsulta("SELECT hs.fecha_inicio AS fecha, CONCAT(hs.latitud,', ',hs.longitud) AS ubicacion,hs.id_historial AS id FROM usuarios AS u INNER JOIN historial_sesiones AS hs ON u.id_usuario = hs.id_usuario 
WHERE u.id_usuario = $id_alumno ORDER BY hs.fecha_inicio DESC"); 
$pagina->ejecutar();
echo "<table class='table table-hover table-bordered table-striped'>";
echo "<thead><tr class='info'><th>Fecha de sesion</th><th>Ubicacion</th><th></th></tr></thead>";
while($rs=$pagina->fetchResultado()){ 
    $id_sesion = $rs['id'];
echo "<tr>";
     echo "<td><b>".$rs['fecha']."</b></td>";
        ...
        <section class="col-lg-5 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <a href="listar_sesiones.php"><button class="btn btn-info pull-right">Ver sesiones</button></a>
            </ul>
            <div class="tab-content no-padding">
              <!-- AQUI VA EL MAPA -->
              <div id="map"></div>
