...
<html lang="es"><!--INICIO DEL DOCUMENTO HTML -->
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div id="contenedor_1" class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="fa fa-inbox"></i> Investigaciones</li>
            </ul>
            <div class="tab-content no-padding">
                <!--LISTA DE INVESTIGACIONES DEL ALUMNO -->
                <div class="table-responsive">
                  <table class="table table-hover">
                 <?php 
                       $objetoNegocios->listarInvestigacion();
                 ?>
                 </div>
                 </table>
            </div>
